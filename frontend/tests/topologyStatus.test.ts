...
assert.match(managedSpokesView, /haStatus\.selection_mode === 'manual'/)
assert.match(managedSpokesView, /api\.setManagedSpokeHAMode/)
assert.match(managedSpokesView, /设为手动目标/)
