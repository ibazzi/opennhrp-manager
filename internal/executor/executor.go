...
type HACandidateInfo struct {
	...
	QualityRTTMs          *float64 `json:"quality_rtt_ms"`
	QualitySamples        uint     `json:"quality_samples"`
	QualityFailures       uint     `json:"quality_failures"`
	LastQualityReplyAgeMs *float64 `json:"last_quality_reply_age_ms"`
